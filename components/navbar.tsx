...
export default function Navbar({ isScrolled }: NavbarProps) {
  ...
  // Static primary CTA color after removing colorState
  const colorClass = "bg-purple-600 hover:bg-purple-700";
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button
            className={`px-6 py-2 rounded-lg text-white font-medium text-sm transition ${colorClass}`}
          >
            GET STARTED
          </button>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-4 py-4 flex flex-col gap-4">
            ...
            <button className="text-gray-600 hover:text-gray-900 text-left font-medium">
              Sign in
            </button>
            ...
            <button
              className={`w-full px-4 py-2 rounded-lg text-white font-medium text-sm transition ${colorClass}`}
            >
              GET STARTED
            </button>
          </div>
